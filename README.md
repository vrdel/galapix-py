...
- `--rust`: accepted for compatibility; temporary caches are always prepared with the bundled Rust tool
...
- `--rust`: accepted for compatibility; SQLite caches are always prepared with the bundled Rust tool
...
- `o`: open selected image selection in a separate viewer window inheriting current view options
